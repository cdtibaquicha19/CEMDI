...
window.open(url, "CHAT SISTEMA ", "width=900, height=600")
        ...
        <a class"btn btn-danger" href="javascript:finestraSecundaria('https://sistema.sandracamacho.com.co/view/chat/')">
...
<div class="panel panel-default">
 ...
 <strong>Sandracamacho.com.co</strong> 
...
if (!empty($_POST['submit'])) {
	    ...
	    $field = array("nombre_depa"=>$_POST['nombre'], 
